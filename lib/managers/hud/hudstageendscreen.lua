...
function HUDStageEndScreen:create_money_counter(t, dt)
	...
	self._money.balance = {
		...
		},
		{
			...
			0 < spending_earned and tweak_data.screen_colors.friend_color or tweak_data.screen_colors.pro_color
		},
...
function HUDStageEndScreen:animate_level_progress(o, data)
	local animate_func = function(o, self, data)
		...
		current_xp, gained_xp, speed = spin_func(self, o, 0 < #data and 0 or data.start_t.current, data.end_t.current, data.end_t.total, current_xp, gained_xp, speed, true)
