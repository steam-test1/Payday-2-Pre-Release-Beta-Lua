...
function CopLogicAttack._upd_combat_movement(data)
	...
	if my_data.stay_out_time and (not (not enemy_visible_soft and my_data.at_cover_shoot_pos) or action_taken or want_to_take_cover) then
